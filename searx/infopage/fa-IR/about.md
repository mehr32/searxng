...
SearXNG یک [موتور فراجستجو] است که نتایج دیگر موتور جستجو ها را جمع می کند
{{link('search engines', 'preferences')}} در حالی که اطلاعات مربوط به جستجو را ذخیره نمی‌کند
...
- SearXNG به آنچه شما جستجو می کنید اهمیتی نمی دهد، هرگز چیزی را با افراد شخص ثالث به اشتراک نمی گذارد
   شخص ثالث، و نمی توان از آن برای به خطر انداختن شما استفاده کرد.
- SearXNG نرم افزار رایگان است، کد 100٪ باز است و همه از آن استقبال می کنند
   بهترش کنید.

اگر به حریم خصوصی اهمیت می دهید، می خواهید یک کاربر آگاه باشید، یامی‌خواهید در آزادی دیجیتال باشید،
...
می تواند به نوار جستجوی مرورگر شما اضافه شود. علاوه بر این، می توان آن را به عنوان تنظیم کرد
موتور جستجوی پیش فرض

{{link('stats page', 'stats')}} حاوی چند کاربرد ناشناس مفید است
آمار موتورهای مورد استفاده

## چگونه می توانم آن را مال خودم کنم؟

SearXNG از نگرانی شما در مورد گزارش‌ها قدردانی می‌کنمد، بنابراین کد را از
...
حفظ حریم خصوصی آنها و آزادتر کردن اینترنت. هر چه غیرمتمرکزتر باشد
اینترنت است، آزادی بیشتر است!
